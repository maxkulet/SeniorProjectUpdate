...
public class StepFiveOnFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View thumb1View = view.findViewById(R.id.step5_on_imagebtn1);
        final View thumb2View = view.findViewById(R.id.step5_on_imagebtn2);
        ...
        thumb1View.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.drawable.bag,  R.id.step5_on_expanded1, R.id.step5_on_layout);
            }
        });
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.drawable.mesh,  R.id.step5_on_expanded2, R.id.step5_on_layout);
            }
        });
