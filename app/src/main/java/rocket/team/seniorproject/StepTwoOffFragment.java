...
public class StepTwoOffFragment extends Fragment {
    ...
    ImageButton nextStep2Off, step2_off_imagebtn1, step2_off_imagebtn2;;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        step2_off_imagebtn1 = (ImageButton) view.findViewById(R.id.step2_off_imagebtn1);
        step2_off_imagebtn2 = (ImageButton) view.findViewById(R.id.step2_off_imagebtn2);
        ...
        nextStep2Off.setOnClickListener(new View.OnClickListener() {
            ...
            {
                MainActivity.myDeviceSecurity = getString(R.string.content9_summary_on);
                MainActivity.myDeviceOS = getString(R.string.content9_summary_on);
        ...
        final View thumb1View = view.findViewById(R.id.step2_off_imagebtn1);
        final View thumb2View = view.findViewById(R.id.step2_off_imagebtn2);
        thumb1View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.drawable.anroid_model,  R.id.step2_off_expanded1, R.id.step2_off);
            }
        });
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.drawable.iphone_model,  R.id.step2_off_expanded2, R.id.step2_off);
            }
        });
