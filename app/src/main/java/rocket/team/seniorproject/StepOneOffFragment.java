...
public class StepOneOffFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                    ...
                    alert
                            ...
                            .setPositiveButton("GOT IT",new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,int id) {
                                    ...
                                    fragmentTransaction.replace(R.id.flContent, stepTwoOff, "stepTwoOff");
        ...
        final View thumb1View = view.findViewById(R.id.off_image1);
        final View thumb2View = view.findViewById(R.id.off_image2);
        thumb1View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb1View, R.drawable.blood, R.id.step1_layout_off, R.id.off_expanded_image1);
        ...
        thumb2View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                zoomImageFromThumb(thumb2View, R.drawable.dna, R.id.step1_layout_off, R.id.off_expanded_image2);
                // zoomImageFromThumb(thumb1View, R.drawable.blood, R.id.step1_on_layout, R.id.expanded_image2);
            }
        });
